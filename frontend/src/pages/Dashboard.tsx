...
import { useEnrollments, useRecommendations } from '@/hooks/useApi';
...
export const Dashboard: FC = () => {
  ...
  const activeEnrollments = enrollments.slice(0, 3);
    ...
    <div className="space-y-8 p-8 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      ...
      <div className="space-y-2">
        ...
        <p className="text-slate-600">
          You're on a{' '}
          <span className="font-semibold text-orange-600 flex items-center gap-1 inline-flex">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="border-slate-200 shadow-md hover:shadow-lg transition-all bg-white">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-600 font-medium">Learning Streak</p>
          ...
          <CardContent className="space-y-3">
            <div className="space-y-2">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold">Complete DSA Module 3</p>
                  <p className="text-xs text-muted-foreground">3 lessons left</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold">Take DSA Quiz</p>
                  <p className="text-xs text-muted-foreground">Eligible after module completion</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-muted text-muted-foreground text-sm font-semibold flex-shrink-0">
                ...
                <div>
                  <p className="text-sm font-semibold">Take Proctored Exam</p>
                  <p className="text-xs text-muted-foreground">Get your certificate</p>
                </div>
              </div>
            </div>
          </CardContent>
